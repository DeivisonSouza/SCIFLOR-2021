...
<div class="my-footer"><span>Prof. Dr. Deivison Venicio Souza (E-mail: deivisonvs@ufpa.br)&emsp;&emsp;&emsp;&emsp;&emsp; <div3>Minicurso: Introdução ao R para Análise de Dados</div3>/ <div2>Parte 1 - Introdução à Linguagem de Programação R</div2> </div>
...
* Realizar o download e a instalação do RGui e IDE Rstudio;
...
[4 - Indexação de data frames](#IndDF)

[5 - Indexação de listas](#IndL)
]
...
.font200[**.white[Parte 1] <br> .yellow[Conhecendo o R e <br> o IDE Rstudio]**]
...
.font200[**.white[Parte 2] <br> .yellow[Estrutura de dados <br> na linguagem R]**]
...
.font200[**.white[Parte 3] <br> .yellow[Indexação no R]**]
...
.font200[**.white[Parte 5] <br> .yellow[Um pouco mais <br> sobre o R]**]
