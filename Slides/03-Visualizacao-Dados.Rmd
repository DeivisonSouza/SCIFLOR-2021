...
[2 - O pacote ggplot2](#ggplot)

[3 - Conjunto de dados - IF100%](#data)

[4 - Gráficos de pontos (dispersão)](#point)
...
.pull-right-4[
.font80[
```{r ref.label="gg", out.width='80%', echo=F, eval=T}
```
]
]
...
## Pacote ggplot2 (tidyverse)
<br>
### Camada base - Adionando mapeamento estético
...
.pull-right-4[
.font80[
```{r ref.label="gg2", out.width='80%', echo=F, eval=T}
```
]
]
...
.pull-right-4[
.font80[
```{r ref.label="point1", out.width='80%', echo=F, eval=T}
```
]
]
...
## Pacote ggplot2 (tidyverse)
<br>
### Gráfico de pontos (dispersão) + linha de regressão
...
.pull-right-4[
.font80[
```{r ref.label="point2", out.width='80%', echo=F, eval=T}
```
]
]
...
.pull-right-4[
.font80[
```{r ref.label="point3", out.width='80%', echo=F, eval=T}
```
]
]
...
## Pacote ggplot2 (tidyverse)
<br>
### Gráfico de pontos (dispersão) - Estética de pontos
...
.pull-right-4[
.font80[
```{r ref.label="point4", out.width='80%', echo=F, eval=T}
```
]
]
...
.pull-left-4[
.font70[
- Mudando a forma (shape) dos pontos...
...
.pull-right-4[
.font80[
```{r ref.label="point5", out.width='80%', echo=F, eval=T}
```
]
]
...
.pull-right-4[
.font80[
```{r ref.label="point6", out.width='80%', echo=F, eval=T}
```
]
]
...
.pull-right-4[
.font80[
```{r ref.label="point7", out.width='80%', echo=F, eval=T}
```
]
]
...
.pull-left-4[
.font70[
- É possível customizar as formas, cores e tamanhos dos pontos facilmente...
...
- Use .green[scale_shape_manual()] e .green[scale_color_manual()] para definir a forma e cor desejada para os pontos, respectivamente.
]
]

.pull-right-4[
.font80[
```{r ref.label="point8", out.width='80%', echo=F, eval=T}
```
]
]
