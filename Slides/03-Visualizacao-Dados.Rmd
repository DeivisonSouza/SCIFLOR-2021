...
&nbsp;&nbsp;&nbsp;&nbsp;[6.3 - Representando duas (ou mais) variáveis](#rdv)

&nbsp;&nbsp;&nbsp;&nbsp;[6.4 - Modificando cores das barras](#mcb)

&nbsp;&nbsp;&nbsp;&nbsp;[6.5 - Reordenando as barras](#rb)

&nbsp;&nbsp;&nbsp;&nbsp;[6.6 - Adicionando rótulos nas barras](#arb)

[7 - Histograma de frequência](#hf)
...
# x <- data_sample2 %>%
#   select(Nome_Especie, Selecao) %>% 
#   tidyr::pivot_longer(!Nome_Especie,
#                       names_to = "Variavel",
#                       values_to = "Valor") %>% 
#   ggplot() +
#     geom_bar(mapping = aes(x = Nome_Especie, 
