...
- Nesta função os argumentos básicos são: 
  ...
  + .blue[aes()]: função de estética (aesthetic) ou mapeamento das variáveis.
- A execução da função .green[ggplot()] sem especificações gera simplesmente a base do gráfico (sem elementos estéticos e geométricos).
]
]
