...
- Para adicionar camadas usa-se o operador .red[**+**].
- **2ª camada**: A função .blue[geom_point()] foi usada para adicionar uma camada de pontos no gráfico. Tem-se um gráfico de dispersão.
]
]
...
- **3ª camada**: A função .blue[geom_smooth()] foi usada para adicionar uma linha de regressão linear (y~x = V~DAP).
]
]
...
- **4ª camada**: A função .blue[geom_smooth()] foi usada para adicionar uma linha de regressão polinomial de segundo grau (y~x<sup>2</sup> = V~DAP<sup>2</sup>).
]
]
...
- Buscar dados melhores
- Mostrar cor baseado nas espécies
- arrumar labs
