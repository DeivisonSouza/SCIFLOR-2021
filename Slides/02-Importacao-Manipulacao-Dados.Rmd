...
[2 - O pacote readr](#readr)

[3 - Arquivo de valores separados por vírgula](#csv)

[4 - Arquivo de valores separados por ponto e vírgula](#csv2)

[5 - Arquivo de valores separados por tabulação](#tsv)

[6 - Arquivo de valores separados por um delimitador incomum](#delim)

[7 - Importação de dados usando a GUI do Rstudio](#importdata)
...
- RStudio IDE $\rightarrow$ Environment $\rightarrow$ .blue[Import Dataset].
]
