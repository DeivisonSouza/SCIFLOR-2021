...
# Importa o arquivo "file1"
(file2 <- readr::read_csv(file="data/file1.csv", 
...
# Importa o arquivo "file1"
(file3 <- readr::read_csv(file="data/file1.csv", 
                          col_types = "fdi"))
```
...
# Importa o arquivo "file1"
(file4 <- readr::read_csv(file = "data/file1.csv", 
...
### Arquivo de valores separados por tabulação
